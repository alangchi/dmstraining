    ...
    */
    ...
    public function login() {
        ...
        if ( ! Auth::attempt($login)){
            return Redirect::back()->withMessage('Invalid user login');
        }else{
        ...
        }elseif($user_data['role_name']  == 'manager'){
            
            return redirect('/logout');
        }

        return redirect()->route('borrowers.devices.dashboard');
    }
   /*
     * Logout
     * author: @Chi (chi.al@neo-lab.vn)
     */
